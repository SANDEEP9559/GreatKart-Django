...
def payments(request):
    ...
    # send order number and transsaction id back to send data metho via json response
    data = {
...
def place_order(request, total = 0, quantity = 0):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            # Store all te billing information inside order Table
            data = Order()
            ...
            current_date = d.strftime("%Y%m%d") #20220416
